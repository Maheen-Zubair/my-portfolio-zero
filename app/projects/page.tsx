...
import image5 from "../public/e-commerce picture.png"
...
<div className="container-no-1  min-w-[200px] sm:min-w-[250px] md:min-w-[300px] h-60 bg-black rounded-xl p-4 cursor-pointer ">
            <h3 className="text-md sm:text-xl font-semibold text-customGray5">E-Commerce Website</h3>
            <Link href={"https://e-commercefinal-project-marketplace.vercel.app"} target="_blank" className="block mt-2 text-white  hover:underline">
            <Image
              src={image5}
              alt="image"
              sizes="fit"
          ...
          <div className="container-no-1  min-w-[200px] sm:min-w-[250px] md:min-w-[300px] h-60 bg-black rounded-xl p-4 cursor-pointer ">
           ...
           <Link href={"https://company-portfolio-nex5-rgxalyhnn-maheen-zubairs-projects.vercel.app"} target="_blank" className="block mt-2 text-white  hover:underline">
            <Image
              src={image}
              alt="image"
              sizes="fit"
          ...
          <div className="container-no-3  min-w-[200px] sm:min-w-[250px] md:min-w-[300px] h-60 bg-black rounded-xl p-4 cursor-pointer  shadow drop-shadow-2xl shadow-black">
            ...
            <Link href={"https://ass5-smoothies-1klq-en7xwf7gk-maheen-zubairs-projects.vercel.app"} target="_blank" className="block mt-2 text-white  hover:underline">
            <Image
              src={image3}
              alt="image"
              sizes="fit"
          ...
          <div className="container-no-4  min-w-[200px] sm:min-w-[250px] md:min-w-[300px] h-60 bg-black rounded-xl p-4 cursor-pointer  shadow drop-shadow-2xl shadow-black">
            ...
            <Link href={"https://milestone-1-lvpwialk4-maheen-zubairs-projects.vercel.app"} target="_blank" className="block mt-2 text-white  hover:hover:underline">
            <Image
              src={image4}
              alt="image"
              sizes="fit"
          ...
          <div className="container-no-2  min-w-[200px] sm:min-w-[250px] md:min-w-[300px] h-60 bg-black rounded-xl p-4 cursor-pointer shadow drop-shadow-2xl shadow-black">
            ...
            <Link href={"https://resume-generator-m-5-9ydkrbefy-maheen-zubairs-projects.vercel.app"} target="_blank" className="block mt-2 text-white  hover:underline">
            <Image
              src={image2}
              alt="image"
              sizes="fit"
