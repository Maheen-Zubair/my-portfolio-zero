...
export default function Contact() {
  return (
    <div>
      <div
        id="Contact"
        className="mainContainer bg-customgray3 sm:h-screen flex flex-col sm:flex-row justify-center items-center"
      >
        {/* Left Section */}
        <div className=" flex flex-col items-center sm:items-start text-center sm:text-left mt-10 sm:gap-5 sm:mt sm:mr-15 sm:mb-32 sm:ml-10 ">
          <h1 className="sub-title text-4xl sm:text-5xl md:text-6xl font-bold text-white">
            Contact Me
          </h1>
          <ul className="mt-4 space-y-2">
            <li className="text-lg sm:text-xl font-normal text-customGray5 flex gap-2">
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="size-6 inline text-orange-400"
              >
                <path
                  strokeLinecap="round"
            ...
            <li className="text-lg sm:text-xl font-normal text-customGray5 flex gap-2">
              ...
              <svg
                ...
                height="20"
                viewBox="0 0 50 50"
                className="fill-orange-400 inline"
              >
          ...
          <div className="social-icons flex mt-4 space-x-4">
            ...
            <Link
              href="https://www.linkedin.com/in/maheen-zubair-27692a2ba/"
              target="_blank"
            ...
            <Link
              href="https://github.com/Maheen-Zubair"
              target="_blank"
              className="text-white"
            >
              <svg
        ...
        <div className=" w-full sm:w-1/2 flex flex-col justify-center items-center mt-10 sm:mt-0">
          <form
            ...
            action="https://formspree.io/f/xgvykqbb"
            method="POST"
          >
            <input
              type="text"
